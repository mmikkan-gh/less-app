...
## V17 — Jerarquía tipográfica

Se establece una única regla tipográfica para **PARA SER**, **PARA RECORDAR** y **AGENDA**, incluyendo mayúsculas, fuente, tamaño, peso, color, espaciado e icono. También se normaliza la jerarquía interna de Agenda.

---

## V16 — Etiquetas de sección unificadas

- **Para Ser**, **Para Recordar** y **Agenda** usan exactamente la misma tipografía, tamaño, peso, mayúsculas, espaciado y color.
